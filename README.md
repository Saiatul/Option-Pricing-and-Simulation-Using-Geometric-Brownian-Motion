...
## 🚀 Overview
This project simulates stock price paths using **Geometric Brownian Motion (GBM)** and applies **Monte Carlo methods** to price different types of options.
...
## 🔍 Insights
- Higher volatility ⬆️ increases option prices  
- Path-dependent options behave differently from standard European options  
- Monte Carlo simulation is flexible for complex derivatives  
